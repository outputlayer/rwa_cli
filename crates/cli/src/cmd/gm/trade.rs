...
fn trade_json(
    ...
    TradeJson {
        ...
        actual_slippage_pct,
        // `order.price_impact` is already a PERCENT (normalized at source —
        // swap/v2 native, Metis mapper ×100), unit-consistent with the
        // `slippage_pct` field beside it. Echo it verbatim.
